...
const addressSchema = yup.object().shape({
  ...
  address: yup.object().shape({
    ...
    state: yup.string().required("Necessitamos dos detalhes para entrega"),
    ...
    <div className="p-5 sm:p-8 bg-white">
      ...
      >
        ...
        <Input
          ...
          variant="outline"
          placeholder="Introduza a Rua e o Número da Porta"
          className="col-span-2"
        />
        <Input
          label="Apt e Detalhes"
          {...register("address.state")}
          error={errors?.address?.state?.message}
          variant="outline"
          placeholder="Exemplo 2º Drto"
          className="col-span-2"
        />
        <Input
          label="Instruções"
